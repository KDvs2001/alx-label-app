...
export const getSlides = (contrastLight, onClose) => [
        ...
        content: (
            <div className="h-full flex flex-col justify-center items-center text-center gap-6 max-w-4xl mx-auto py-2">
                ...
                <div className="space-y-4 mt-4">
                    <h1 className={`text-5xl md:text-7xl font-black tracking-tight leading-none uppercase ${contrastLight ? 'text-slate-955' : 'text-white'}`}>
    ...
    // SLIDE 2 — THE QUESTION
    {
        ...
        content: (
            <div className="h-full flex flex-col justify-center items-center text-center gap-6 max-w-4xl mx-auto py-2">
                ...
                <div className="mt-8">
                    <span className="text-3xl font-black text-rose-500 animate-pulse uppercase tracking-widest">Take a guess.</span>
                </div>
            </div>
        )
    },
    // SLIDE 3 — THE ANSWER
    {
        ...
        content: (
            <div className="h-full flex flex-col justify-center items-center gap-6 max-w-6xl mx-auto py-2 px-4">
                <div className="text-center">
                    <h2 className={`text-5xl md:text-7xl font-black tracking-tight uppercase ${contrastLight ? 'text-slate-955' : 'text-white'}`}>
                        <span className="text-rose-500">80%</span> of every AI project.
                    </h2>
                    <p className={`text-2xl md:text-3xl font-bold mt-2 ${contrastLight ? 'text-slate-900' : 'text-slate-350'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-8 text-left">
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        ...
                        <h3 className={`text-5xl font-black ${contrastLight ? 'text-slate-950' : 'text-white'}`}>$20B</h3>
                        <p className={`text-lg font-bold flex-1 ${contrastLight ? 'text-slate-800' : 'text-slate-300'}`}>Projected data labeling market by 2030, growing 5x from 2024.</p>
                        <span className="text-sm text-slate-500 font-mono mt-2">Grand View Research</span>
                    </div>
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        <span className="text-sm font-black text-rose-500 uppercase tracking-widest">IMPACT</span>
                        <h3 className={`text-5xl font-black ${contrastLight ? 'text-slate-950' : 'text-white'}`}>60%</h3>
                        <p className={`text-lg font-bold flex-1 ${contrastLight ? 'text-slate-800' : 'text-slate-300'}`}>Of AI projects abandoned by 2026 due to poor data quality.</p>
                        <span className="text-sm text-slate-500 font-mono mt-2">Gartner</span>
                    </div>
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        <span className="text-sm font-black text-emerald-500 uppercase tracking-widest">URGENCY</span>
                        <h3 className={`text-5xl font-black ${contrastLight ? 'text-slate-950' : 'text-white'}`}>$14.3B</h3>
                        <p className={`text-lg font-bold flex-1 ${contrastLight ? 'text-slate-800' : 'text-slate-300'}`}>Meta paid this for 49% of Scale AI in June 2025.</p>
                        <span className="text-sm text-slate-500 font-mono mt-2">Market Deal</span>
                    </div>
                </div>
            </div>
        )
    ...
    // SLIDE 4 — EXISTING SOLUTIONS
    {
        ...
        content: (
            <div className="h-full flex flex-col justify-center items-center gap-6 max-w-5xl mx-auto py-2">
                ...
                <div className={`relative w-full max-w-4xl aspect-video rounded-3xl border-4 flex items-center justify-center p-8 ${contrastLight ? 'bg-white border-slate-900 shadow-2xl' : 'bg-slate-900/60 border-slate-800'}`}>
                    {/* Axes */}
                    ...
                    {/* Labels */}
                    <span className="absolute top-4 left-1/2 -translate-x-1/2 font-black text-lg uppercase text-slate-400 bg-white dark:bg-slate-900 px-2">Cost-Aware</span>
                    <span className="absolute bottom-4 left-1/2 -translate-x-1/2 font-black text-lg uppercase text-slate-400 bg-white dark:bg-slate-900 px-2">Cost-Blind</span>
                    <span className="absolute left-0 top-1/2 -translate-y-1/2 font-black text-lg uppercase text-slate-400 -rotate-90 bg-white dark:bg-slate-900 px-2">Rigid</span>
                    <span className="absolute right-0 top-1/2 -translate-y-1/2 font-black text-lg uppercase text-slate-400 rotate-90 bg-white dark:bg-slate-900 px-2">Adaptive</span>

                    {/* Competitors (Bottom/Left) */}
                    <div className="absolute bottom-1/4 left-1/4 -translate-x-1/2 translate-y-1/2 bg-slate-100 border-2 border-slate-300 text-slate-700 font-black px-6 py-3 rounded-xl shadow-lg">Prodigy</div>
                    <div className="absolute bottom-1/3 left-1/3 -translate-x-1/2 translate-y-1/2 bg-slate-100 border-2 border-slate-300 text-slate-700 font-black px-6 py-3 rounded-xl shadow-lg">Label Studio</div>
                    <div className="absolute top-2/3 right-1/3 translate-x-1/2 translate-y-1/2 bg-slate-100 border-2 border-slate-300 text-slate-700 font-black px-6 py-3 rounded-xl shadow-lg">Scale AI</div>
                    <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 bg-slate-100 border-2 border-slate-300 text-slate-700 font-black px-6 py-3 rounded-xl shadow-lg">Snorkel Flow</div>
                    <div className="absolute bottom-1/4 right-1/3 translate-x-1/2 translate-y-1/2 bg-slate-100 border-2 border-slate-300 text-slate-700 font-black px-6 py-3 rounded-xl shadow-lg">Doccano</div>
    ...
    // SLIDE 5 — THE GAPS
    {
        ...
        content: (
            <div className="h-full flex flex-col justify-center gap-6 max-w-7xl mx-auto py-2 px-4">
                {[
                    { num: "1", type: "PRIORITY 1 · BUSINESS", title: "Nobody prices per sample", desc: "Every tool assumes a tweet and a 500-word document cost the same. Result: teams pay for hours of trivial labels.", badge: "Confirmed by 19 of 31 surveyed experts", badgeColor: contrastLight ? "bg-rose-100 text-rose-900 border-rose-550 border-2" : "bg-rose-500/10 text-rose-450 border-rose-500/20" },
                    { num: "2", type: "PRIORITY 2 · BUSINESS", title: "Nobody adapts to the annotator", desc: "One-size-fits-all task queues ignore that annotators have different speeds and get tired. Result: burnout and quality drops.", badge: "Flagged in literature (Mortagua, 2025)", badgeColor: contrastLight ? "bg-amber-100 text-amber-905 border-amber-600 border-2" : "bg-amber-500/10 text-amber-400 border-amber-500/20" },
                    { num: "3", type: "PRIORITY 3 · TECHNICAL", title: "Nobody trusts the model early", desc: "Active learning tools use uncalibrated confidence from round one. Result: the model picks bad samples and the loop degrades.", badge: "Failure mode in 52% of AL benchmarks", badgeColor: contrastLight ? "bg-purple-100 text-purple-900 border-purple-650 border-2" : "bg-purple-500/10 text-purple-400 border-purple-500/20" }
                ].map((gap) => (
                    <div key={gap.num} className={`p-8 rounded-3xl border-4 flex flex-col md:flex-row gap-8 justify-between items-start md:items-center ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-850'}`}>
                        <div className="flex gap-6 items-start text-left w-full">
                            <div className="w-20 h-20 rounded-2xl bg-rose-500/10 text-rose-600 flex items-center justify-center font-black text-4xl shrink-0 border-2 border-rose-550/20">
                                {gap.num}
                            </div>
                            <div className="space-y-3 flex-1">
                                <div className={`text-base font-black uppercase tracking-widest ${contrastLight ? 'text-slate-800' : 'text-slate-500'}`}>{gap.type}</div>
                                <h4 className={`font-black text-3xl ${contrastLight ? 'text-slate-955' : 'text-white'}`}>{gap.title}</h4>
                                <p className={`text-xl font-bold ${contrastLight ? 'text-slate-900' : 'text-slate-400'}`}>{gap.desc}</p>
                            </div>
                            <span className={`text-base font-black px-6 py-4 rounded-xl shrink-0 max-w-[300px] text-center ${gap.badgeColor}`}>{gap.badge}</span>
                        </div>
                    </div>
                ))}
            </div>
    ...
    // SLIDE 6 — OUR SOLUTION
    {
        ...
        content: (
            <div className="h-full flex flex-col justify-center items-center gap-8 max-w-7xl mx-auto py-2 px-4">
                <div className={`w-full p-10 rounded-3xl border-4 text-center ${contrastLight ? 'bg-blue-50 border-blue-900 shadow-xl' : 'bg-blue-900/20 border-blue-800'}`}>
                    <h2 className={`text-4xl md:text-5xl font-black uppercase ${contrastLight ? 'text-blue-950' : 'text-blue-100'}`}>
                        Think of it as <span className="text-blue-600">Waze</span> for data labeling.
                    </h2>
                    <p className={`text-2xl font-bold mt-4 ${contrastLight ? 'text-blue-900' : 'text-blue-300'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full text-left">
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        ...
                        <h3 className={`text-3xl font-black uppercase ${contrastLight ? 'text-slate-950' : 'text-white'}`}>Innovation</h3>
                        <p className={`text-lg font-bold leading-relaxed ${contrastLight ? 'text-slate-800' : 'text-slate-300'}`}>
                    ...
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        ...
                        <h3 className={`text-3xl font-black uppercase ${contrastLight ? 'text-slate-950' : 'text-white'}`}>Application</h3>
                        <p className={`text-lg font-bold leading-relaxed ${contrastLight ? 'text-slate-800' : 'text-slate-300'}`}>
                    ...
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        ...
                        <h3 className={`text-3xl font-black uppercase ${contrastLight ? 'text-slate-950' : 'text-white'}`}>Compatibility</h3>
                        <p className={`text-lg font-bold leading-relaxed ${contrastLight ? 'text-slate-800' : 'text-slate-300'}`}>
        ...
        content: (
            <div className="h-full flex flex-col justify-center gap-8 w-full max-w-7xl mx-auto px-6 py-4">
                <div className="flex flex-col gap-6 w-full text-center">
                    <h3 className={`text-4xl md:text-5xl font-black uppercase ${contrastLight ? 'text-slate-950' : 'text-white'}`}>
                        Time to Reach F1 = 0.80
                    </h3>
                    <p className={`text-2xl font-bold ${contrastLight ? 'text-slate-700' : 'text-slate-300'}`}>Averaged across 10 distinct NLP datasets</p>
                    
                    <div className={`p-10 rounded-3xl border-4 space-y-8 mt-4 ${contrastLight ? 'bg-white border-slate-900 shadow-2xl' : 'bg-slate-900/40 border-slate-850'}`}>
                        {[
                            ...
                            return (
                                <div key={idx} className="grid grid-cols-12 gap-8 items-center">
                                    <div className={`col-span-3 text-right text-2xl font-black uppercase ${item.isHighlight ? 'text-rose-500' : contrastLight ? 'text-slate-950' : 'text-slate-300'}`}>
                                        {item.name}
                                    </div>
                                    <div className={`col-span-7 relative h-12 flex items-center rounded-xl border-2 overflow-visible ${contrastLight ? 'bg-slate-100 border-slate-900' : 'bg-slate-955/40 border-slate-900'}`}>
                                        <div className={`absolute h-1 flex items-center justify-between ${contrastLight ? 'bg-slate-950' : 'bg-slate-650'}`} style={{ left: `${ciLeft}%`, width: `${ciWidth}%` }}>
                                            <div className={`w-1 h-6 shrink-0 ${contrastLight ? 'bg-slate-955' : 'bg-slate-650'}`} />
                                            <div className={`w-1 h-6 shrink-0 ${contrastLight ? 'bg-slate-955' : 'bg-slate-650'}`} />
                                        </div>
                                        <div className={`absolute h-10 rounded-lg transition-all duration-1000 ${item.color} ${item.isHighlight ? 'border-4 border-white' : ''} ${contrastLight ? 'border-2 border-slate-950' : ''}`} style={{ width: `${barWidth}%`, left: '0%' }} />
                                    </div>
                                    <div className={`col-span-2 text-3xl font-mono font-black ${item.isHighlight ? 'text-rose-650' : contrastLight ? 'text-slate-955' : 'text-slate-400'}`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full items-stretch">
                    ...
                    <div className={`p-8 rounded-3xl border-4 flex flex-col ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        <table className="w-full text-left border-collapse text-base flex-1">
                            <thead>
                                <tr className={`border-b-4 ${contrastLight ? 'border-slate-900' : 'border-slate-700'}`}>
                                    <th className={`py-4 font-black text-xl ${contrastLight ? 'text-slate-950' : 'text-slate-200'}`}>Features</th>
                                    <th className="py-4 font-black text-rose-600 text-center text-xl">CAL-Log</th>
                                    <th className={`py-4 font-black text-center text-xl ${contrastLight ? 'text-slate-500' : 'text-slate-500'}`}>Prodigy</th>
                                    <th className={`py-4 font-black text-center text-xl ${contrastLight ? 'text-slate-500' : 'text-slate-500'}`}>Scale AI</th>
                                    <th className={`py-4 font-black text-center text-xl ${contrastLight ? 'text-slate-500' : 'text-slate-500'}`}>Snorkel</th>
                                </tr>
                            </thead>
                            <tbody className={`divide-y-2 ${contrastLight ? 'divide-slate-200' : 'divide-slate-800/40'}`}>
                                {[
                                    ...
                                    <tr key={idx}>
                                        <td className={`py-4 font-bold text-lg ${contrastLight ? 'text-slate-950 font-black' : 'text-slate-300'}`}>{row[0]}</td>
                                        <td className="py-4 text-center font-black text-rose-600 text-2xl">{row[1] ? "✓" : "—"}</td>
                                        <td className={`py-4 text-center text-2xl ${contrastLight ? 'text-slate-400 font-bold' : 'text-slate-600'}`}>{row[2] ? "✓" : "—"}</td>
                                        <td className={`py-4 text-center text-2xl ${contrastLight ? 'text-slate-400 font-bold' : 'text-slate-600'}`}>{row[3] ? "✓" : "—"}</td>
                                        <td className={`py-4 text-center text-2xl ${contrastLight ? 'text-slate-400 font-bold' : 'text-slate-600'}`}>{row[4] ? "✓" : "—"}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    {/* Right: Standards */}
                    <div className={`p-10 rounded-3xl border-4 flex flex-col justify-center ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        <span className="text-xl font-black text-emerald-600 uppercase tracking-widest text-center mb-8">STANDARDS COMPLIANT</span>
                        <div className="space-y-6 text-2xl font-bold">
                            <div className="flex items-center gap-4"><CheckCircle2 size={32} className="text-emerald-500 shrink-0"/> <span className={`${contrastLight ? 'text-slate-900' : 'text-slate-200'}`}>UK GDPR · 0 trackers, 0 PII</span></div>
                            <div className="flex items-center gap-4"><CheckCircle2 size={32} className="text-emerald-500 shrink-0"/> <span className={`${contrastLight ? 'text-slate-900' : 'text-slate-200'}`}>BCS Code of Conduct</span></div>
                            <div className="flex items-center gap-4"><CheckCircle2 size={32} className="text-emerald-500 shrink-0"/> <span className={`${contrastLight ? 'text-slate-900' : 'text-slate-200'}`}>OWASP · 0 critical vulnerabilities</span></div>
                            <div className="flex items-center gap-4"><CheckCircle2 size={32} className="text-emerald-500 shrink-0"/> <span className={`${contrastLight ? 'text-slate-900' : 'text-slate-200'}`}>WCAG · accessible by design</span></div>
                            <div className="flex items-center gap-4"><CheckCircle2 size={32} className="text-emerald-500 shrink-0"/> <span className={`${contrastLight ? 'text-slate-900' : 'text-slate-200'}`}>Nielsen Heuristics · 8 of 10 clean</span></div>
                            <div className="flex items-center gap-4"><CheckCircle2 size={32} className="text-emerald-500 shrink-0"/> <span className={`${contrastLight ? 'text-slate-900' : 'text-slate-200'}`}>99%+ uptime · verified by UptimeRobot</span></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        content: (
            <div className="h-full flex flex-col justify-center gap-6 max-w-7xl mx-auto py-2 px-4">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <div className="px-6 py-3 rounded-full border-4 border-slate-300 bg-slate-100 text-slate-800 font-black text-lg md:text-xl">42 Experts Contacted</div>
                    <div className="px-6 py-3 rounded-full border-4 border-rose-500 bg-rose-500 text-white font-black text-lg md:text-xl shadow-lg shadow-rose-500/30">31 Usable Responses</div>
                    <div className="px-6 py-3 rounded-full border-4 border-slate-300 bg-slate-100 text-slate-800 font-black text-lg md:text-xl">19 AL/NLP Researchers</div>
                    <div className="px-6 py-3 rounded-full border-4 border-slate-300 bg-slate-100 text-slate-800 font-black text-lg md:text-xl">12 ML Engineers</div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch mt-4">
                    {/* Quotes */}
                    <div className={`p-8 rounded-3xl border-4 flex flex-col gap-6 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                        ...
                        <div className="p-5 rounded-2xl bg-slate-100 dark:bg-slate-800/50">
                            <p className="text-lg font-bold italic">"Strong practical and commercial value. The balance between utility and annotation time is effective."</p>
                            <span className="block mt-3 text-base font-black text-rose-500">— Evaluator 19 · ML Engineer</span>
                        </div>
                        <div className="p-5 rounded-2xl bg-slate-100 dark:bg-slate-800/50">
                            <p className="text-lg font-bold italic">"75.6% improvement over baselines, with a clear peak at 60 minutes of annotation."</p>
                            <span className="block mt-3 text-base font-black text-rose-500">— Evaluator 13 · AL Researcher</span>
                        </div>
                        <div className="p-5 rounded-2xl bg-slate-100 dark:bg-slate-800/50">
                            <p className="text-lg font-bold italic">"Cost angle is an important but largely neglected dimension in current active learning."</p>
                            <span className="block mt-3 text-base font-black text-rose-500">— Evaluator 2 · Domain Expert</span>
                        </div>
                    </div>
        ...
        content: (
            <div className="h-full flex flex-col justify-center gap-8 w-full max-w-7xl mx-auto py-2 px-4">
                ...
                <div className={`p-8 rounded-3xl border-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                    <h3 className={`text-2xl font-black uppercase mb-6 ${contrastLight ? 'text-slate-950' : 'text-white'}`}>TECHNICAL VALIDATION (PUBLISHED IN)</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xl font-bold">
                        <div className="flex items-start gap-4">
                            <div className="h-12 w-12 bg-rose-100 text-rose-600 rounded-xl border-2 border-rose-300 flex items-center justify-center font-black shrink-0"><BookOpen size={24} /></div>
                            <span><b className="text-rose-500">ACL 2026:</b> Accepted, presented, and published (A* NLP)</span>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="h-12 w-12 bg-blue-100 text-blue-600 rounded-xl border-2 border-blue-300 flex items-center justify-center font-black shrink-0"><FileText size={24} /></div>
                            <span><b className="text-blue-500">IEEE CSNT 2026:</b> Accepted</span>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="h-12 w-12 bg-emerald-100 text-emerald-600 rounded-xl border-2 border-emerald-300 flex items-center justify-center font-black shrink-0"><BookOpen size={24} /></div>
                            <span><b className="text-emerald-500">ICAIIC 2026:</b> Published</span>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="h-12 w-12 bg-purple-100 text-purple-600 rounded-xl border-2 border-purple-300 flex items-center justify-center font-black shrink-0"><FileText size={24} /></div>
                ...
                <div className={`p-8 rounded-3xl border-4 ${contrastLight ? 'bg-white border-slate-900 shadow-xl' : 'bg-slate-900/60 border-slate-800'}`}>
                    <h3 className={`text-2xl font-black uppercase mb-10 text-center ${contrastLight ? 'text-slate-950' : 'text-white'}`}>THE ROADMAP</h3>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between relative px-10 pb-6">
                        ...
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center z-10 gap-4 group text-center px-4">
                                <div className={`w-24 h-24 rounded-full border-4 bg-slate-900 flex items-center justify-center shadow-xl transition-transform transform group-hover:scale-110 ${item.color}`}>
                                    <item.icon size={36} className={item.color.split(' ')[0]} />
                                </div>
                                <div>
                                    <span className={`block text-sm font-black uppercase tracking-widest mt-2 ${contrastLight ? 'text-slate-500' : 'text-slate-400'}`}>{item.step}</span>
                                    <h4 className={`text-2xl font-black mt-1 ${contrastLight ? 'text-slate-900' : 'text-white'}`}>{item.title}</h4>
                                    <p className={`text-base font-bold mt-1 ${contrastLight ? 'text-slate-700' : 'text-slate-300'}`}>{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
